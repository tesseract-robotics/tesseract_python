...
%inline {
tesseract::common::CalibrationInfo parseCalibrationConfigString(const tesseract::scene_graph::SceneGraph& scene_graph,
...
tesseract::common::KinematicsPluginInfo parseKinematicsPluginConfigString(const std::string& yaml_str)
{
