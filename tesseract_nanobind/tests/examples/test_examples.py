...
CORE_EXAMPLES = ROOT_DIR / "examples"
...
def test_kinematics_example():
    _load_module("tesseract_kinematics_example", CORE_EXAMPLES / "tesseract_kinematics_example.py").main()
...
def test_freespace_ompl_example():
    _load_module("freespace_ompl_example", CORE_EXAMPLES / "freespace_ompl_example.py").main()


@pytest.mark.planning
def test_basic_cartesian_example():
    _load_module("basic_cartesian_example", CORE_EXAMPLES / "basic_cartesian_example.py").main()


@pytest.mark.planning
def test_glass_upright_example():
    _load_module("glass_upright_example", CORE_EXAMPLES / "glass_upright_example.py").main()


@pytest.mark.planning
def test_puzzle_piece_example():
    _load_module("puzzle_piece_example", CORE_EXAMPLES / "puzzle_piece_example.py").main()


@pytest.mark.planning
def test_pick_and_place_example():
    _load_module("pick_and_place_example", CORE_EXAMPLES / "pick_and_place_example.py").main()


@pytest.mark.planning
def test_car_seat_example():
    _load_module("car_seat_example", CORE_EXAMPLES / "car_seat_example.py").main()
