...
setup(name='tesseract-robotics-viewer',
      ...
      url='https://github.com/tesseract-robotics/tesseract_nanobind',
	  ...
	  license='Apache-2.0',
	  install_requires=['numpy','tesseract_robotics>=0.6.0','opencv-contrib-python','aiohttp','importlib-resources'],
