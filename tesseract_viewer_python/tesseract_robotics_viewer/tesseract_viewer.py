...
class TesseractViewer():
    ...
    def save(self, directory, overwrite=False):
        ...
        resource_package = importlib_resources.files('tesseract_robotics_viewer.resources') / "static"

        # Read the contents as bytes (equivalent to resource_string)
        index_html = (resource_package / "index.html").read_bytes()
        tesseract_viewer_js = (resource_package / "tesseract_viewer.js").read_bytes()
