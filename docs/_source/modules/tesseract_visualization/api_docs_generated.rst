...
* ``MarkerType_ARROW``
* ``MarkerType_AXIS``
* ``MarkerType_CONTACT_RESULTS``
* ``MarkerType_GEOMETRY``
* ``MarkerType_LINE_LIST``
* ``MarkerType_LINE_STRIP``
* ``MarkerType_NONE``
* ``MarkerType_POINTS``
* ``MarkerType_TEXT``
* ``MarkerType_TOOLPATH``
* ``MarkerType_TRIANGLE_FAN``
* ``MarkerType_TRIANGLE_LIST``
* ``MarkerType_TRIANGLE_STRIP``
* ``MarkerType_USER_DEFINED``
